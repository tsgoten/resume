...
\header{Work Experience}
    \employer{Research Assistant}
    {Research in AI for Sustainable Energy (RAISE Lab)}{September 2020 -- Present}{Berkeley, CA}
	\begin{bullet-list-minor}
	\item Augmenting Reinforcement Learning with a Planning Model for Optimizing Energy Demand Response 
	\item Responsible for the implementation of hierarchical RL agents and general operation of the project. 
    \end{bullet-list-minor}


    \employer{Head Undergraduate Student Instructor (TA)}
    {-- UC Berkeley EECS Department}{June 2020 -- Present}{Berkeley, CA}
	\begin{bullet-list-minor}
	\item Head Teaching Assistant for CS70: Discrete Mathematics and Probability Theory. 
